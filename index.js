...
// This file contains only the modified functions to improve collection name extraction
// Insert these into your main code file

// =========================================================
// API SERVICES - ENHANCED METHODS
// =========================================================
...
// =========================================================
// METADATA MANAGER - ENHANCED METHODS
// =========================================================
...
// =========================================================
// SERVER MANAGER - NEW API TEST ENDPOINT
// =========================================================
...
// Add this to the setupServer method in the ServerManager class
setupServer() {
...
// Update the help method to include the new endpoint
handleHelp(req, res) {
  const helpText = `
